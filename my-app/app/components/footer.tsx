...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-[#111D15] pt-20 pb-8">
            ...
            <ul className="flex flex-col gap-4">
              {companyLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-[#c7cdc9] font-[400] text-[16px] hover:text-[#36B864] transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div className="flex flex-col gap-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <input
                ...
                className="w-full px-5 py-4 rounded-[10px] bg-transparent border border-[#3a453e] text-white placeholder:text-[#8b948e] text-[15px] outline-none focus:border-[#36B864] transition-colors"
                required
              />
              <button
                type="submit"
                className="w-fit bg-[#36B864] text-white font-[600] text-[15px] rounded-[10px] px-8 py-3.5 flex items-center justify-center gap-2 cursor-pointer hover:bg-[#2ea055] transition-colors"
              >
                Send
              </button>
            </form>
